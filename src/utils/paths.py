...
MODELS_PATH_FILE = MODELS_DIR / "models_paths"
...
CLASSIFICATIONS = [
    ...
    # Normal_anomaly
    {'dataset_type': (f"{NB15_SAT20_PREFIX}"), 'path': (DATA_DIR / f"{HYBRID_PREFIX}{PREPROCESSED_SUFFIX}/{NB15_SAT20_PREFIX}{NORMAL_ANOMALY_DIR_NAME}/Normal_Syn_DDoS{DATA_FILE_TYPE}")},
    {'dataset_type': (f"{NB15_SAT20_PREFIX}"), 'path': (DATA_DIR / f"{HYBRID_PREFIX}{PREPROCESSED_SUFFIX}/{NB15_SAT20_PREFIX}{NORMAL_ANOMALY_DIR_NAME}/Normal_UDP_DDoS{DATA_FILE_TYPE}")},

    {'dataset_type': (f"{NB15_TER20_PREFIX}"), 'path': (DATA_DIR / f"{HYBRID_PREFIX}{PREPROCESSED_SUFFIX}/{NB15_SAT20_PREFIX}{NORMAL_ANOMALY_DIR_NAME}/Normal_Botnet{DATA_FILE_TYPE}")},
    {'dataset_type': (f"{NB15_TER20_PREFIX}"), 'path': (DATA_DIR / f"{HYBRID_PREFIX}{PREPROCESSED_SUFFIX}/{NB15_SAT20_PREFIX}{NORMAL_ANOMALY_DIR_NAME}/Normal_DDoS{DATA_FILE_TYPE}")},
    {'dataset_type': (f"{NB15_TER20_PREFIX}"), 'path': (DATA_DIR / f"{HYBRID_PREFIX}{PREPROCESSED_SUFFIX}/{NB15_SAT20_PREFIX}{NORMAL_ANOMALY_DIR_NAME}/Normal_Syn_DDoS{DATA_FILE_TYPE}")},
    {'dataset_type': (f"{NB15_TER20_PREFIX}"), 'path': (DATA_DIR / f"{HYBRID_PREFIX}{PREPROCESSED_SUFFIX}/{NB15_SAT20_PREFIX}{NORMAL_ANOMALY_DIR_NAME}/Normal_UDP_DDoS{DATA_FILE_TYPE}")}
]
