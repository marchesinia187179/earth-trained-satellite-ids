...
\begin{frame}{Takeaways e Sviluppi Futuri}
  \begin{columns}[T]
    % TAKEAWAYS
    \begin{column}{0.5\textwidth}
      \begin{block}{\textbf{Takeaways}}
        \scriptsize \textcolor{unimoreMaroon}{\textbf{01}} - \textbf{La prestazione in-domain non garantisce robustezza cross-domain}

        \vspace{0.2cm}

        \scriptsize \textcolor{unimoreMaroon}{\textbf{02}} - \textbf{Una conoscenza target estremamente limitata può favorire la generalizzazione preservando il sorgente}

        \vspace{0.2cm}

        \scriptsize \textcolor{unimoreMaroon}{\textbf{03}} - \textbf{La robustezza è un compromesso tra adaptation e retention}
      \end{block}
    \end{column}
