...
Ciononostante, la sola protezione del dominio di superficie si dimostra inadeguata laddove si richieda la copertura di regioni orograficamente complesse\footnote{Aree geografiche caratterizzate da una morfologia del terreno irregolare (es. zone montuose o valli strette) che introducono ostacoli fisici alla linea di vista (\textit{Line-of-Sight}), fenomeni di attenuazione addizionale e impraticabilità per la posa delle infrastrutture cablate terrestri.} o una ridondanza critica, imponendo l'estensione dell'architettura trasmissiva verso il segmento spaziale.
