...
tuttavia, il nostro approccio si differenzia nettamente in quanto lo studio di Tavallaee et al. si limita all'analisi statistica e alla valutazione di benchmark su un singolo dataset sintetico, senza analizzare sistematicamente il comportamento del classificatore di fronte a fenomeni di \textit{domain shift} eterogenei né valutare l'impatto comparato tra la granularità di rilevamento binaria e multiclasse.
