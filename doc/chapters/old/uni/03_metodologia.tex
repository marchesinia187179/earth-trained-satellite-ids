    ...
    \end{table}
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                ...
                \begin{scope}[shift={(0,0)}]
                    % Assi
                    \draw[->, thick] (0,0) -- (6,0) node[right] {\footnotesize $FPR$};
                    \draw[->, thick] (0,0) -- (0,6) node[above] {\footnotesize $TPR$};
                    
                    % Griglia di riferimento
                    \draw[gray!30, thin] (0,5) -- (5,5) -- (5,0);
                    \node[below left] at (0,0) {\small $0$};
                    \node[below] at (5,0) {\small $1$};
                    \node[left] at (0,5) {\small $1$};
                    
                    % Area sottesa (AUC) in toni di grigio
                    \fill[gray!20] (0,0) -- plot[smooth, domain=0:5] (\x, {5*sqrt(\x/5)}) -- (5,0) -- cycle;
                    
                    % Baseline casuale (diagonale)
                    \draw[dashed, gray!80] (0,0) -- (5,5);
                    
                    % Curva ROC
                    \draw[thick, black, smooth, domain=0:5] plot (\x, {5*sqrt(\x/5)});
                    
                    % Etichette
                    \node at (2.3, 1.2) {\footnotesize $AUC_{ROC}$};
                    \node[above] at (3, 6) {\textbf{(a) Curva ROC}};
                \end{scope}

                % --- Sottofigura (b): Curva Precision-Recall ---
                \begin{scope}[shift={(7.5,0)}]
                    % Assi
                    \draw[->, thick] (0,0) -- (6,0) node[right] {\footnotesize $Recall\ (TPR)$};
                    \draw[->, thick] (0,0) -- (0,6) node[above] {\footnotesize $Precision$};
                    ...
                    % Area sottesa (AUC) in toni di grigio
                    \fill[gray!20] (0,5) -- plot[smooth, domain=0:5] (\x, {5 - 2.2*(\x/5)^2}) -- (5,0) -- (0,0) -- cycle;
                    
                    % Baseline prevalenza (linea orizzontale)
                    \draw[dashed, gray!80] (0,0.8) -- (5,0.8) node[right] {\small $\pi$};
                    
                    % Curva PR
                    \draw[thick, black, smooth, domain=0:5] plot (\x, {5 - 2.2*(\x/5)^2});
                    
                    % Etichette
                    \node at (1.2, 1.2) {\footnotesize $AUC_{PR}$};
                    \node[above] at (3, 6) {\textbf{(b) Curva PR}};
                \end{scope}
            \end{tikzpicture}
