...
La variabilità delle evidenze sperimentali è stata caratterizzata mediante una valutazione multi-seed; i confronti tra configurazioni sono stati inoltre sottoposti a un'analisi inferenziale esplorativa mediante test $t$ di Welch, applicato senza sfruttare esplicitamente la struttura appaiata derivante dall'impiego del medesimo insieme nominale di seed.
