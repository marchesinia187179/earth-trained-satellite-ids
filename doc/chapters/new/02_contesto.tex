...
\begin{figure}[H]
    ...
    \node [node_accent, right=1.6cm of b_train] (b_test) {
        \textbf{Test Target (Distribuzione Differente)}\\
        (Possibile Degrado Prestazionale)
    };
    \node [node_alert, right=0.8cm of b_test] (b_res) {
        \textbf{Possibile Degrado}\\[-5pt]
        \textbf{Prestazionale}
    };
