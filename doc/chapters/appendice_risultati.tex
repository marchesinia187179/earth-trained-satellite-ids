...
% MAPPE DI CALORE
% ==============================================================================
\section{Mappe di Calore della Cross-Evaluation}
\label{app:heatmap_cross_evaluation}

La presente sezione riporta le rappresentazioni grafiche aggregate delle
matrici di valutazione ottenute nel protocollo di \textit{cross-evaluation}.
Le mappe di calore complementano il dettaglio numerico riportato nelle
sezioni precedenti, fornendo una rappresentazione sinottica del comportamento
dei modelli rispetto ai differenti benchmark di test.

\subsection{Mappe di Calore Aggregate della TPR}
\label{app:heatmap_tpr}
