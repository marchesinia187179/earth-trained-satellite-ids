...
\begin{figure}[H]
    ...
    \begin{scope}[shift={(0,0)}]
        ...
        \draw[arrow_flow] (0, 0) -- (3, 0) coordinate (centro_asse) -- (6, 0) node[right] {$x_1$};
        ...
        \node[below, font=\footnotesize] at (centro_asse) {Lo shift $\boldsymbol{\eta}$ viene assorbito dall'ampio margine.};
    \end{scope}
