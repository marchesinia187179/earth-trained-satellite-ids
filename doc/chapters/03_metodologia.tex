    ...
    \label{sec:tassonomia_modelli}
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}[
                ...
                % --- BAGGING (Left side) ---
                \node (bagging_title) at (-4,6) {\textbf{Bagging (Parallelo)}};
                ...
                % --- BOOSTING (Right side) ---
                \node (boosting_title) at (4,6) {\textbf{Gradient Boosting (Sequenziale)}};
                ...
                \node [below=0.4cm of tree_b2] (dots_boost) {\vdots};
                ...
                \draw [arrow] (tree_b2) -- (dots_boost) node[midway, right, font=\footnotesize] {+ $\nu \cdot f_2$};
