...
\begin{figure}[H]
    ...
    \begin{scope}[on background layer]
        \node[group_box, fit={(leo) (geo) (rf_attack)}] (gspace) {};
        \node[group_box, fit={(nids_space) (gateway) (terminal) (core) (nids_ground) (logic_attack)}] (gter) {};        
    \end{scope}
...
\begin{tabularx}{\textwidth}{l >{\raggedright\arraybackslash}p{1.7cm} >{\raggedright\arraybackslash}p{2.1cm} >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X}
\toprule
\textbf{Rif.} & \textbf{Dominio} & \textbf{Approccio} & \textbf{Punto di Forza} & \textbf{Limiti e Gap} \\[-5pt]
 &  &  &  & \textbf{Metodologico} \\
\midrule
\cite{sommer2010} &
Terrestre &
